  ...
  return (
    <div className='w-screen h-full flex flex-col justify-center bg-base-100'>
      ...
      <div id='pembukaan' className='w-screen bg-base-100 p-4 flex flex-col gap-4 pt-10 border-b-2 border-black pb-8'>
        <h1 className='text-center text-2xl font-serif font-semibold poppins'>Assalamualaikum Wr. Wb.</h1>

        <article className='capitalize text-center font-semibold poppins'>
          Dengan memohon rahmat dan ridho Allah Subhanahu wa ta'ala Yang Telah menciptakan mahluk-Nya secara berpasang-pasangan, kami bermaksud menyelenggarakan pernikahan kami.
        </article>
        ...
        <div className='flex justify-center'>
          <div className='w-max bg-base-100 rounded-xl shadow-md p-2'>
            <div className='w-full bg-gradient-to-r from-[#D4E7C5] to-[#BFD8AF] rounded-md flex flex-col gap-4 p-8'>
              ...
              <div className='flex justify-arround gap-8 w-full my-4'>
                <div className='font-semibold text-xl border-r-2 p-4 text-center border-black'>Minggu</div>
                <span>
                  <span className='font-semibold text-2xl'>12</span> <br />
                  <span className='font-semibold'>2024</span>
                </span>
                <div className='font-semibold text-xl border-l-2 p-4 text-center border-black'>Mei</div>
              </div>
